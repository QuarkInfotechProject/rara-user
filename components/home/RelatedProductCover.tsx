...
import RelatedTrekCard from "./TrekCard/RelatedTrekCard";

interface RelatedProductCoverProps {
  title?: string;
  data: RelatedCircuit[];
}
...
const RelatedProductCover = ({
  ...
  const getSubtitle = () => {
    switch (title.toLowerCase()) {
      ...
      case "related treks":
        return "Similar adventures";
      case "related tours":
        return "Explore more";
      case "related activities":
        return "More experiences";
      default:
      ...
      <div className="flex items-end justify-between mb-8">
        <div className="flex flex-col gap-1">
          ...
          <h1 className="text-3xl lg:text-4xl flex items-center gap-1 font-bold text-gray-900">
            ...
            <span className="text-[#71B344]">{getDisplayTitle()}</span>
          </h1>
        </div>
...
export default RelatedProductCover;
